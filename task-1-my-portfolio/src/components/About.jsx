  ...
  return (
    <>
      <section className="p-12 text-center">
        <h1 className="text-4xl mt-5 underline underline-offset-8 decoration-cyan-500">
        ...
        <p className="py-12">
          ...
          backend services using Node.js and Express.I completed my Bachelor of
          Technology in Mechanical Engineering from Aurangabad College of
          ...
          focusing on web technologies. I enjoy solving problems, building clean
          user interfaces, and developing full stack applications using the MERN
          stack.
        </p>
      </section>
    </>
